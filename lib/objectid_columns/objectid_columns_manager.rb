module ObjectidColumns
  class ObjectidColumnsManager
    def initialize(active_record_class)
      ...
      @oid_columns = { }
      @dynamic_methods_module = ObjectidColumns::DynamicMethodsModule.new(active_record_class, :ObjectidColumnsDynamicMethods) do
    ...
    def has_objectid_columns(*columns)
      ...
      to_objectid_columns(columns).each { |oid_column| oid_columns[oid_column.column_name] = oid_column }
    ...
    def install_methods!
      ...
      oid_columns.keys.sort.each { |c| columns[c].install_methods!(dynamic_methods_module) }
    end
